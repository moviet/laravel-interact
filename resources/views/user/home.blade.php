...
<div class="container-head">
		<div class="content-top">
			...
			<div class="map-url-home">
					<a href="/home/{{$id}}" class="map-url-dashboard">Dashboard &#9829;</a> <span class="map-url-home-link">Home</span>
			</div>
			...
			<div class="col-sm-5 margin-profile box-profile left">
					...
					@if (empty($groupId) && empty($groupBridge))
							<div class="margin-item box-profile left">
									<div class="card h-100">
										<div class="card-body">
											<div class="label-top"><a href="/search" class="label-top">Friends</a></div>
											<div class="row">
					...
					@if (!empty($groupId) && !empty($groupBridge))
							...
							<div class="margin-item box-profile left">
									<div class="card h-100">
											<div class="card-body">
													<div class="label-top"><a href="/search" class="label-top">
