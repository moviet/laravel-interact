...
<div class="find-wrapper">
		<div class="find-top">
				<div class="map-url-search">
						<a href="/home/{{Auth::user()->uid}}" class="map-url-dashboard">Dashboard &#9829;</a> <span class="map-url-link">Search</span>
				</div>
								...
								@foreach ($name as $friend)						
										...
										<div class="find-box-filled left">			
												...
												<div class="find-user-button">
														<input type="submit" onClick="window.location.href='/user/{{$friend->id}}';" class="find-add-friend" value="Add as friend">
												</div>
										</div>
								@endforeach
						@endif
