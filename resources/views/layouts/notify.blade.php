          ...
          <tr>
            <td align="center" valign="top">
                    ...
                    <td>
                      <div><!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          ...
                          <center>
                        <![endif]-->
                            <a href="{{ route('home.what') }}"
                      style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Welcome</a>
                        <!--[if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]--></div>
                ...
                <table style="margin: 0 auto 30px auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#414141">
                  ...
                  <tr>
                    <td><label style="color:#dddddd; font-size:13px; font-weight:300; font-family:Segoe UI;">
