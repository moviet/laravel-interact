...
@section('title') 
Interaksi - Connect, Share And Free Learning
@endsection
		...
		<div class="wrap-home100">
			<form class="home100-form validate-form" name="register" method="POST" action="{{route('register')}}">
				...
				<div class="flex-m w-full p-b-27">
					<div class="contact100-form-checkbox">
						...
						<label class="label-checkbox100" for="ckb1">
							<span class="term1">
								I agree to the
								<a href="{{ route('index.about') }}" class="term2 hov1">
									Terms of User
								</a>
							</span>
						</label>
				...
				<div class="container-home100-form-btn">
					...
					<a href="{{ url('/login') }}" class="dis-block txt3 hov1 p-r-20 p-t-10 p-b-10 p-l-20">
